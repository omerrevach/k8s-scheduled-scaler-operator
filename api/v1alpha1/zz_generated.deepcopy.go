...
func (in *DeploymentsReference) DeepCopyInto(out *DeploymentsReference) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeploymentsReference.
func (in *DeploymentsReference) DeepCopy() *DeploymentsReference {
	if in == nil {
		return nil
	}
	out := new(DeploymentsReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ScalerSpec) DeepCopyInto(out *ScalerSpec) {
	*out = *in
	if in.Deployments != nil {
		...
		*out = make([]DeploymentsReference, len(*in))
		copy(*out, *in)
	}
}
